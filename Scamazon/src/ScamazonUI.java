...
// TODO add your handling code here:
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ItemArray[0].getItemName());
        System.out.println(ItemArray[0].getPrice());
        System.out.println(ItemArray[0].getSeller());
        System.out.println(ItemArray[0].getIsbn());
        System.out.println(ItemArray[0].getDescription());
        System.out.println(ItemArray[0].getCategory());
        System.out.println(ItemArray[0].getRating());
        System.out.println(ItemArray[0].getStock());
